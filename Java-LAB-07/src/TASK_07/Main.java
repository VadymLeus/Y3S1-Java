...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Сума (однопотокова): " + singleThreadSum);
        System.out.println("Час виконання (однопотоковий): " + singleThreadDuration + " ms");

        startTime = System.currentTimeMillis();
        int multiThreadSum = calculateSumMultiThread(array);
        long multiThreadDuration = System.currentTimeMillis() - startTime;

        System.out.println("Сума (багатопотокова): " + multiThreadSum);
        System.out.println("Час виконання (багатопотоковий): " + multiThreadDuration + " ms");
    }
